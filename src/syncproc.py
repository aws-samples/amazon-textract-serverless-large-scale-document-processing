...
import datastore
from helper import AwsHelper, DynamoDBHelper, S3Helper
...
def processRequest(request):
    ...
    if documentId and bucketName and objectName and features:
        print(
            "DocumentId: {}, features: {}, Object: {}/{}".format(
                documentId, features, bucketName, objectName
            )
        )

        processImage(
            documentId, features, bucketName, objectName, outputTable, documentsTable
        )
